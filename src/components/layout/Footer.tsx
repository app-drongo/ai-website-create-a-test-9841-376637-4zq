...
export default function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'Company',
      links: [
        { name: 'About Test Website', href: '#about' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Customer Success', href: '/case-studies' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Empowering businesses with advanced analytics and data-driven insights. Join
                thousands of companies who trust Test Website for their data intelligence needs.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (555) DATA-123</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">456 Analytics Plaza, Data District</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get weekly data insights and platform updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Built with <Heart className="size-3 text-red-500 fill-current" /> for data
                excellence
              </span>
            </div>
